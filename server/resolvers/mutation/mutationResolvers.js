...
module.exports = {
  Mutation: {
    async borrowBook(
      ...
      try {
        const { userID, library } = authUtil.authenticate(app, req) // saves authenticated ID in the borrower_id variable. .authenticate function returns userID.
        // console.log(book_id);
        // console.log(borrower_id);
        // console.log("borrowBook");

        const checkStatusQuery = {
          text: `SELECT * FROM libraryapp.books WHERE id=$1 AND library_id=$2`,
          values: [book_id, library]
        }
